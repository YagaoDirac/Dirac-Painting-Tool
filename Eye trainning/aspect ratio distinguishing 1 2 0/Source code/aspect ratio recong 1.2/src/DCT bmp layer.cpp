...
//.h of this
#include "../include/DCT bmp layer.h"
...
//
////init
//DCT_bmp_layer_component_uchar_x3::error_type DCT_bmp_layer_component_uchar_x3::init(size_t in_width, size_t in_height)
//{
...
//}
//DCT_bmp_layer_component_uchar_x3::error_type DCT_bmp_layer_component_uchar_x3::__init_force(size_t in_width, size_t in_height)
//{
...
//
////utilities
//inline void DCT_bmp_layer_component_uchar_x3::__set_mem(size_t offset, unsigned char r, unsigned char g, unsigned char b)
//{	memory[offset].r = r; memory[offset].g = g; memory[offset].b = b;}
//inline int DCT_bmp_layer_component_uchar_x3::clamp_coord(int in, int lo, int hi)
//{	return in < lo ? lo : (in < hi ? in : (hi - 1));}
//inline size_t DCT_bmp_layer_component_uchar_x3::get_offset(int x, int y) const
//{return (y*width + x);}
//inline size_t DCT_bmp_layer_component_uchar_x3::get_row_offset() const
...
//
////init
//DCT_bmp_layer_component_uchar_x4::error_type DCT_bmp_layer_component_uchar_x4::init(size_t in_width, size_t in_height)
//{
//	if (in_width > 4096 || in_height > 4096)
//		return error_type::to_init_size_greater_than_4096__invoke_init_force;
//
...
//	return error_type::OK;
//}
//DCT_bmp_layer_component_uchar_x4::error_type DCT_bmp_layer_component_uchar_x4::__init_force(size_t in_width, size_t in_height)
//{
//	if (in_width > safe_size() || in_height > safe_size())
//		return error_type::bad_param;
//
...
//
////utilities
//inline void DCT_bmp_layer_component_uchar_x4::__set_mem(size_t offset, unsigned char r, unsigned char g, unsigned char b)
//{memory[offset].r = r;memory[offset].g = g;memory[offset].b = b;}
//inline int DCT_bmp_layer_component_uchar_x4::clamp_coord(int in, int lo, int hi)
//{return in < lo ? lo : (in < hi ? in : (hi - 1));}
//inline size_t DCT_bmp_layer_component_uchar_x4::get_offset(int x, int y) const
//{return (y*width + x);}
//inline size_t DCT_bmp_layer_component_uchar_x4::get_row_offset() const
//{return size_t(width * 4);}
//
//void DCT_bmp_layer_component_uchar_x4::draw_dot_rgb_raw(int x, int y, unsigned char r, unsigned char g, unsigned char b, bool safecheck)
//{
//	if (safecheck)
//	{
...
//	return;
//}
//void DCT_bmp_layer_component_uchar_x4::draw_dot_rgb_raw(int x, int y, DCT_color_rgba_f color, bool safecheck)
//{
//	draw_dot_rgb_raw(x, y,
//		static_cast<unsigned char>(color.r * 255),
//		static_cast<unsigned char>(color.g * 255),
//		static_cast<unsigned char>(color.b * 255), safecheck);
//}
//void DCT_bmp_layer_component_uchar_x4::draw_line_xyx_rgb_raw(int x_start, int y, int x_end_involved, unsigned char r, unsigned char g, unsigned char b, bool safecheck)
//{
//	if (safecheck)
//	{
...
//	}
//}
//void DCT_bmp_layer_component_uchar_x4::draw_line_xyx_rgb_raw(int x_start, int y, int x_end_involved, DCT_color_rgba_f color, bool safecheck)
//{
...
//		static_cast<unsigned char>(color.b * 255), safecheck);
//}
//void DCT_bmp_layer_component_uchar_x4::draw_line_xyy_rgb_raw(int x, int y_start, int y_end_involved, unsigned char r, unsigned char g, unsigned char b, bool safecheck)
//{
//	if (safecheck)
//	{
...
//	}
//}
//void DCT_bmp_layer_component_uchar_x4::draw_line_xyy_rgb_raw(int x, int y_start, int y_end_involved, DCT_color_rgba_f color, bool safecheck)
//{
...
//}
//
//void DCT_bmp_layer_component_uchar_x4::draw_sq_rgb_raw(int x_start, int x_end_involved, int y_start, int y_end_involved, unsigned char r, unsigned char g, unsigned char b, bool safecheck)
//{
//	if (safecheck)
//	{
//		if (x_start < 0 && x_end_involved < 0)return;
...
//	}
//}
//void DCT_bmp_layer_component_uchar_x4::draw_sq_rgb_raw(int x_start, int x_end_involved, int y_start, int y_end_involved, DCT_color_rgba_f color, bool safecheck)
//{
...
//*/
//
//void DCT_bmp_layer_component_uchar_x4::how_to_inside()
//{
//	/*
//	Step 1 ctor.
